...
- **Vendored to:** `skills/android/skills/google/`
- **License file:** `skills/android/skills/google/LICENSE`

The SKILL.md files under `skills/android/skills/google/` are copied verbatim from the upstream repository. MobiAI-Core does not modify their content. Redistribution complies with Apache 2.0 §4: the original `LICENSE.txt` is preserved alongside the vendored content, and attribution is documented both in this file and in `README.md`.
