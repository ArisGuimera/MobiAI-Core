---
name: mobile-subagent-development
description: Use when executing mobile implementation plans with independent tasks in the current session
license: MIT
...
- Have implementation plan from `mobile-planning`
- Tasks mostly independent
- Want to stay in this session

**vs. mobile-executing-plans:** Same session, fresh subagent per task, two-stage review, faster iteration.
...
- **`mobile-tdd`** - Subagents follow TDD for each task
