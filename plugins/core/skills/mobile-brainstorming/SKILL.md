...
8. **Transition to implementation** — invoke `mobile-planning` skill to create implementation plan
...
- Invoke the `mobile-planning` skill to create a detailed implementation plan
- Do NOT invoke any other skill. `mobile-planning` is the next step.
