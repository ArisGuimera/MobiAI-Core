...
**Called by:**
- **`mobile-brainstorming`** - When design approved and implementation follows
- **`mobile-subagent-development`** - Before executing any tasks
- **`mobile-executing-plans`** - Before executing any tasks

**Pairs with:**
- **`mobile-finishing-branch`** - Cleans up worktree after work complete
