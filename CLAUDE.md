...
The full skill catalog is at `skills/using-mobiai/SKILL.md`. It loads automatically on session start and lists all available skills with a decision guide for when to use each one.
